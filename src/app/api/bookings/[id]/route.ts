    ...
    const { data, error } = await supabase
      ...
      .select(`
        *,
        ...
        assigned_guide:employees!bookings_assigned_guide_id_fkey(id, first_name, last_name, phone, email),
        assigned_vehicle:vehicles(id, registration_number, make, model, vehicle_type, capacity),
